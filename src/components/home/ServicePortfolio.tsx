    ...
    <section className="max-w-[90rem] mx-auto py-20 px-6 sm:px-8 lg:pt-20 lg:p-10 lg:pb-20 w-full grow flex flex-col  md:gap-20 md:overflow-hidden relative min-h-screen 2xl:min-h-fit ">
      <div className="md:rounded-[60px] rounded-3xl bg-[#F1F9F6]  py-10  md:py-[86px]">
        <div className="px-4 md:px-20">
          ...
          <p className="text-black  md:text-xl text-sm font-medium md:font-semibold font-inter leading-loose md:leading-[50px]">
            ...
            goals and surpass their expectations. We&apos;ve helped shape
            numerous success stories, propelling our clients to new heights in
            the blockchain space. <br />
            ...
            expertise fueled the creation of an immersive educational program
            for an arcade, educating aspiring blockchain enthusiasts. This
            program served as a launching pad for several innovative crypto
